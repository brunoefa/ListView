...
public class Parte3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.parte3);
		...
		// Criar um ArrayAdapter do tipo String, que vai fazer aparecer as Strings acima em seu ListView do tipo que checked
	...
	public void btnMarcados_click(View view){
		...
		Toast.makeText(this, "Estados marcados : " + lstrEstadosSelecionados, Toast.LENGTH_SHORT).show();
	}
